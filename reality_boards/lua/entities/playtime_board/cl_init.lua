...
local title = "Ranks"
local content = [[
You might've noticed that other
people on the server have swagalicous
colors that come with their ranks.
You can get these ranks for yourself
if you have the dedication.

Member - 3h (red)
Regular - 36h (yellow)
Dedicated - 72h (yellow-green)
Addict - 1w (orange)
Veteran - 2w (purple)
]]
