...
local title = "Titles"
local content = [[
See that colored text above
other peoples' heads? Yours looks
really stupid right now.
You can change that, though!

If you want to completely disable
it, simply type nothing in the box
and click submit.

Walk on over to the Title Vendor
(to your left), and use him to
set your title.
]]
